...
=======
	...
	inline vec3 operator*(const vec3 &v1, const vec3 &v2) { //none of the * or / are prototyped
...
=======
	inline vec3 operator/(vec3 v, float t) { //not sure why this is not passing by reference / const
>>>>>>> remotes/origin/master
...
<<<<<<< HEAD
	...
	vec3 random_in_unit_sphere() {
		...
		do {
			...
			p = 2.0*vec3(o.randm(), o.randm(), o.randm()) - vec3(1, 1, 1);
			//std::cout << p << "\n";
